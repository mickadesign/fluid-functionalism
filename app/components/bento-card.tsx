...
export function BentoCard({ slug, name, isNew, gridSize = "small", children }: BentoCardProps) {
  return (
    <div
      className={cn(
    ...
    >
      ...
      <Link
        ...
        className="group/link flex items-center gap-2 px-4 py-3 border-t border-border/40 rounded-b-xl transition-colors duration-80 hover:bg-muted/50 outline-none focus-visible:shadow-[inset_0_0_0_1px_#6B97FF]"
      >
        <span
