...
export const componentList: ComponentEntry[] = [
  ...
  { slug: "color-picker", name: "ColorPicker", description: "Color picker with HEX/RGB/HSL/OKLCH formats, alpha, swatches, and popover trigger.", isNew: true, gridSize: "large" },
